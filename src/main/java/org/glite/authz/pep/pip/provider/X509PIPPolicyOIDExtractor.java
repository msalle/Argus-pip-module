 ...
 */
public class X509PIPPolicyOIDExtractor extends AbstractPolicyInformationPoint {
	/** Class logger. */
	private final Logger log = LoggerFactory.getLogger(X509PIPPolicyOIDExtractor.class);
	 ...
	 */
	public final static String ATTRIBUTE_IDENTIFIER = "http://authz-interop.org/xacml/subject/ca-policy-oid";
	 ...
	 */
	public X509PIPPolicyOIDExtractor(String pipid) {
		super(pipid);
	}
